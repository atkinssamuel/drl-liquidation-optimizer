...
class DiscreteActorNetwork(nn.Module):
    def __init__(self, n_actions, input_dims, alpha,
                 fc1_dims=256, fc2_dims=256, chkpt_dir='ppo/src/discrete/models'):
...
class DiscreteCriticNetwork(nn.Module):
    def __init__(self, input_dims, alpha, fc1_dims=256, fc2_dims=256,
                 chkpt_dir='ppo/src/discrete/models'):
...
class DiscreteAgent:
    def __init__(self,
        ...
        self.memory = DiscretePPOMemory(batch_size)
