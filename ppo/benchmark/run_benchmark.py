...
if __name__ == '__main__':
    num_increments = 1000
    env = SingleAgentAlmgrenChrissDiscrete(D=5, increments=num_increments)
    N = 20
    batch_size = 5
    n_epochs = 4
    alpha = 0.0003
    agent = Agent(n_actions=num_increments, batch_size=batch_size,
                    alpha=alpha, n_epochs=n_epochs,
                    input_dims=env.observation_space.shape)
    n_games = 2000

    figure_file = 'plots/rewards.png'
