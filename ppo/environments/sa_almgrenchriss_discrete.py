...
class SingleAgentAlmgrenChrissDiscrete(gym.Env):
    """
    Initial Parameters:
    ...
    """
    def __init__(self, D, increments):
        # action space is continuous and 1-dimensional for a single agent
        self.increments = increments
        self.action_space = Box(low=0, high=1, shape=(self.increments,), dtype=np.float32)
